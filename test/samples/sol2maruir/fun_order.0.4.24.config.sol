...
contract __IRTest__ {
    function main() public payable {
        ...
        assert(L.stringEq(res, "Internal call with no other calls:argument,receiver,Internal call: argument,receiver, External call: receiver,argument, External Solidity Call: receiver,argument,"));
    }
}
