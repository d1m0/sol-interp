...
import { ArtifactInfo, ContractInfo, ImmMap, PartialSolcOutput, zip3, bigEndianBufToBigint } from "sol-dbg";
...
export async function replayMainnetTX(txReplayInfo: ReplayInfo, quicknodeEndpoint: string, etherscanKey: string, maxNumSteps: number, srcDumpDir?: string): Promise<void> {
    try {
