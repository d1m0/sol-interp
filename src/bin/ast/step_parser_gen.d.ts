...
export type StartRuleNames = "Step";
export interface ParseOptions<T extends StartRuleNames = "Step"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"Step">>(
  input: string,
  options?: Options,
): any;
